      ...
      <Slide cascade>
        <div id="about" className="   py-8 md:w-[90%] mx-auto">
          ...
          <p className="text-sm  mb-4">
            Welcome to <strong className="handlee font-bold text-2xl">Gamer Lounge</strong>, the ultimate destination
          ...
          <p className="text-sm mb-2">
            <strong><span className="underline ">Email</span>:</strong> support@gamerlounge.com
          </p>
          <p className="text-sm mb-2">
            <strong><span className="underline ">Phone</span>:</strong> +880-1711-GAMER-LOUNGE
          </p>
          <p className="text-sm">
            <strong><span className="underline ">Address</span>:</strong> 123 Gaming Street, Gulshan, Dhaka City.
          </p>
          </div>
          <div className="items-center my-4">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29204.88962097372!2d90.37730962192968!3d23.796855529941773!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c7a7ba38543b%3A0x91d5f14ad296d72e!2sGulshan%202%2C%20Dhaka%201212!5e0!3m2!1sen!2sbd!4v1733569556715!5m2!1sen!2sbd" className="h-[100%] w-[80%] mx-auto border-2" ></iframe>
          </div>
          </div>
        </div>
      </Slide>
