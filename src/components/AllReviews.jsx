...
const AllReviews = () => {
    ...
    return (
        <div className="">
            <div className="my-10">
      <h1 className="text-center text-2xl font-bold my-6"> Checkout All Review By Our Gamers:</h1>
      <div className="grid grid-cols-1  gap-6">
      {
       allReview.map((game,idx) => <div key={idx} className="card w-[80%] mx-auto bg-base-100 shadow-xl p-2 grid grid-cols-2">
        ...
        <div className="card-body">
          ...
          <p className="text-sm font-medium">Releasing Year : {game.year}</p>
